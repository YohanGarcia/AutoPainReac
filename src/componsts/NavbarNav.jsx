                        ...
                        <div className="dropdown drp-user">
                            ...
                            <div className="dropdown-menu dropdown-menu-right profile-notification">
                                ...
                                <ul className="pro-body">
                                    ...
                                    <li><NavLink to="message.html" className="dropdown-item"><i className="feather icon-mail"></i> My Messages</NavLink></li>
                                    <li><NavLink to="auth-signin.html" className="dropdown-item"><i className="feather icon-lock"></i> Lock Screen</NavLink></li>
                                </ul>
                            </div>
                        </div>
                    </li>
